...
{
    public class ValueTypePatchGeneratorTests : IClassFixture<GeneratorTestFixture>
    {
        private readonly GeneratorTestFixture fixture;

        public ValueTypePatchGeneratorTests(GeneratorTestFixture fixture, ITestOutputHelper outputHelper)
        {
